...
class R1_T03_02_Int_Stoperica_Ver_001_2024
{
    ...
    static void Main()
    {
        ...
        Console.Write("++".PadLeft(24) + "--".PadLeft(17) + "*2".PadLeft(17) + "/2".PadLeft(17) + "%2".PadLeft(17) + "<<2".PadLeft(17) + ">>2".PadLeft(17));
    ...
    static void Ceo_004_short_006_mn2(short B) { for (int i = 0; i < N; i++) B <<= 2; }     // ne kompajlira B = B << 2;
    static void Ceo_004_short_007_de2(short B) { for (int i = 0; i < N; i++) B >>= 2; }     // ne kompajlira B = B >> 2;
